...
CUDA_VISIBLE_DEVICES=0 python class_incremental_cifar100.py \
    --nb_cl_fg 2 --nb_cl 2 --nb_protos 20 \
    --resume --rs_ratio 0.0 \
    --random_seed 1993 \
...
--nb_cl_fg 2 --nb_cl 2 \
--order checkpoint/seed_1993_humandetection_order_run_0.pkl \
--ckp_prefix checkpoint/seed_1993_rs_ratio_0.0_class_incremental_cifar100_nb_cl_fg_2_nb_cl_2_nb_protos_20_run_0_
